    ...
    <div class="content-layout">
      <article class="article" id="article">
        ...
        <section id="${id}-directory" style="margin-top:var(--space-16);">
          ...
          <h2 style="margin-top:var(--space-2);">Get Connected with Your Local ICF Expert</h2>
          <p style="color:var(--color-text-muted);max-width:540px;">Tell us about your project and we'll connect you with qualified ICF professionals in ${name}.</p>
          <div style="margin-top:var(--space-6);">
            <a href="/early-access.html" class="btn btn-primary btn-lg">Get Connected &rarr;</a>
